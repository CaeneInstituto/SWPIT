  ...
  if (step === 'success') {
    return (
      <div className="py-6 space-y-5">
        ...
        <div className="text-center">
          <p className="text-2xl font-extrabold text-gray-900">¡Pago exitoso!</p>
          <p className="text-brand-teal font-bold text-3xl mt-2">S/ {reserveAmountStr}</p>
          <p className="text-sm text-gray-500 mt-1">Pago procesado correctamente</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
          <p className="text-xs text-gray-500 font-semibold mb-1">ID DE TRANSACCIÓN</p>
          <p className="text-xs font-mono text-gray-700 break-all">{chargeId}</p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
          ...
          <p className="text-sm text-blue-800 mt-1">
            <strong>👤 Nombre:</strong> {holderName}
          </p>
          {dni && (
            <p className="text-sm text-blue-800 mt-1">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl px-4 py-3 text-center">
          <p className="text-xs text-yellow-800">
            💡 <strong>Importante:</strong> Guarda tu voucher y el ID de transacción. Te contactaremos por WhatsApp para coordinar detalles del viaje.
          </p>
        </div>
      </div>
    )
